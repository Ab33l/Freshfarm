...
$confirm = ((isset($_POST['confirm']))?sanitize($_POST['confirm']):'');
 ...
 if($emailcount != 0){
    ...
    if(!empty($errors)){
      ...
      $query = $db->query("INSERT INTO Users (FirstName,LastName,Email,PhoneNumber,Password) VALUES ('$fname','$lname','$email','$pnumber','$hashed')");
...
.form-group input:focus + label, .form-group input.active + label{
  ...
  <body>
   ...
   <form action="testing.php" method="POST">
     ...
     <div class="g-recaptcha" data-sitekey="6LdI22MUAAAAAPLqaMlNXvU9qSr8KwQfYbmmz85l"></div>
     <div class="form-group">
